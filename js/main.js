...
// ==============================
// CARROSSEL DE PRODUTOS EXCLUSIVOS (sem bolinhas)
// ==============================
...
if (carouselProdutos && prevProdutos && nextProdutos) {
  ...
  function getTotalPages() {
    const totalWidth = carouselProdutos.scrollWidth;
    const visibleWidth = carouselProdutos.clientWidth;
    return Math.ceil(totalWidth / visibleWidth);
  }

  let totalPages = getTotalPages();

  function showProduto(i) {
    indexProdutos = (i + totalPages) % totalPages;
    const visibleWidth = carouselProdutos.clientWidth;
    carouselProdutos.scrollTo({ left: indexProdutos * visibleWidth, behavior: 'smooth' });
  }
